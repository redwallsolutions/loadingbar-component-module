...
Now, just install it with `npm` or `yarn`.
	...
	npm install @redwallsolutions/loading-bar-component-module
	yarn add @redwallsolutions/loading-bar-component-module --update-checksums

Import it as a normal `npm` module

		import Loading from '@redwallsolutions/loading-bar-component-module'
